...
pattern =r"([1-2][0-9]{3})"
# pattern for Series.str.extract() must be a capture group with parenthesis, otherwise it will cause an error
# pattern = r"[Nn]ational accounts"
...
merged['IncomeGroup'] = merged['IncomeGroup'].str.strip().str.replace(" income[:]?", "").str.upper()
